...
CREATE TABLE `commodity` (
  ...
  `commodityName` varchar(100) DEFAULT NULL COMMENT '商品名称',
...
insert  into `commodity`(`commodityId`,`commodityTypeID`,`uOMID`,`commodityName`,`salePrice`) values (1,15,62,'北京烤鸭','500.00'),(2,16,57,'雪碧','7.00'),(3,16,57,'可乐','7.00'),(4,19,58,'空调','3000.00'),(5,17,63,'薯片王','21.00'),(6,15,62,'红烧猪蹄','201.00'),(8,16,57,'哇哈哈','5.00'),(9,18,63,'经典双喜','20.00'),(10,15,70,'红色排骨','129.00'),(11,16,57,'&lt;h1&gt;ss&lt;/h1&gt;','123.00');
...
CREATE TABLE `consumptiondetails` (
  ...
  `consumptionNumber` varchar(50) DEFAULT NULL COMMENT '消费数量',
...
insert  into `consumptiondetails`(`consumptiondetailsId`,`stayRegisterID`,`cID`,`consumptionNumber`,`consumptionMoney`,`consumptionTime`) values (6,1,3,'3','21.00','2016-12-05 11:38:21'),(8,6,1,'2','1000.00','2016-12-06 17:02:37'),(9,18,2,'2','14.00','2017-01-10 11:24:40'),(10,18,3,'1','7.00','2017-01-10 11:25:12'),(11,18,8,'1','5.00','2017-01-10 21:22:23'),(13,16,3,'1','7.00','2017-01-10 21:22:50'),(14,16,8,'1','5.00','2017-01-10 21:22:50'),(15,17,2,'2','14.00','2017-01-11 08:40:36'),(16,17,3,'1','7.00','2017-01-11 08:40:36'),(17,22,2,'2','14.00','2017-01-11 21:08:57'),(18,25,2,'2','14.00','2017-02-21 09:12:05'),(20,26,2,'1','7.00','2017-02-21 15:04:26'),(21,26,8,'1','5.00','2017-02-21 15:04:26'),(22,27,2,'1','7.00','2017-02-21 15:08:36'),(23,28,5,'2','42.00','2017-02-21 16:01:09'),(24,31,2,'1','7.00','2017-02-21 16:12:48'),(25,33,2,'1','7.00','2017-02-22 11:23:40'),(26,32,5,'1','21.00','2017-02-22 11:24:02'),(27,34,1,'1','500.00','2017-02-23 11:15:28'),(29,35,2,'1','7.00','2017-02-23 11:21:37'),(30,36,4,'1','3000.00','2017-02-23 11:22:06'),(31,37,5,'1','21.00','2017-02-23 11:30:19'),(32,42,2,'1','7.00','2017-02-27 09:27:38'),(33,42,8,'2','10.00','2017-02-27 09:27:38'),(34,43,2,'1','7.00','2017-02-28 09:44:46'),(35,41,8,'2','10.00','2017-02-28 09:45:00'),(36,40,3,'1','7.00','2017-02-28 09:45:18'),(37,52,4,'5','15000.00','2018-03-07 20:46:07'),(38,52,5,'1','21.00','2018-03-07 20:46:07'),(39,54,9,'1','20.00','2018-03-07 21:13:17'),(40,54,10,'1','129.00','2018-03-07 21:13:17'),(41,55,9,'1','20.00','2018-03-07 21:20:39'),(42,55,10,'1','129.00','2018-03-07 21:20:39'),(43,56,5,'5','105.00','2018-03-07 21:33:44'),(44,58,5,'1','21.00','2018-03-07 22:44:58'),(45,58,6,'1','201.00','2018-03-07 22:44:58'),(46,59,4,'1','3000.00','2018-03-10 15:32:48'),(47,59,6,'1','201.00','2018-03-10 15:32:48'),(48,61,4,'1','3000.00','2018-03-10 15:38:54'),(49,61,5,'1','21.00','2018-03-10 15:38:54'),(50,64,1,'1','500.00','2018-03-14 16:43:47'),(51,64,2,'1','7.00','2018-03-14 16:43:47'),(52,67,4,'1','3000.00','2018-03-14 17:02:05'),(53,67,5,'1','21.00','2018-03-14 17:02:05'),(54,68,1,'1','500.00','2018-03-14 18:03:04'),(55,68,2,'1','7.00','2018-03-14 18:03:04'),(56,69,2,'1','7.00','2018-03-14 18:07:54'),(57,69,3,'1','7.00','2018-03-14 18:07:54'),(58,71,4,'1','3000.00','2018-03-14 18:11:37'),(59,71,5,'1','21.00','2018-03-14 18:11:37');
...
CREATE TABLE `passenger` (
  ...
  `papersNumber` varchar(50) DEFAULT NULL COMMENT '证件号码',
...
CREATE TABLE `predetermine` (
  ...
  `predetermineDay` varchar(50) DEFAULT NULL COMMENT '预定天数',
...
insert  into `predetermine`(`predetermineId`,`roomID`,`predetermineTargetID`,`passengerID`,`payWayID`,`predetermineStateID`,`arriveTime`,`deposit`,`predetermineDay`,`remind`) values (1,13,1,20,21,67,'2018-03-09 17:16:48','100.00','2',0),(2,14,3,21,21,67,'2018-03-09 17:16:47','100.00','2',0),(3,16,2,23,21,67,'2018-03-09 17:16:46','100.00','2',0),(4,17,4,24,21,67,'2018-03-09 17:16:45','100.00','2',0),(5,18,9,25,21,67,'2018-03-09 17:16:44','100.00','2',0),(6,13,11,26,21,67,'2018-03-09 17:16:43','100.00','1',0),(7,13,12,27,21,67,'2018-03-09 17:16:42','100.00','1',0),(9,19,13,28,21,67,'2018-03-09 17:16:41','200.00','2',0),(10,13,1,29,21,67,'2018-03-09 17:16:38','100.00','2',0),(11,27,3,30,21,67,'2018-03-09 17:16:40','100.00','2',0),(12,18,4,31,21,67,'2018-03-09 17:16:37','200.00','2',0),(13,16,5,32,21,67,'2018-03-09 17:16:38','100.00','1',0),(15,13,11,34,21,66,'2018-03-10 15:35:59','200.00','2',0),(18,17,12,15,21,66,'2018-03-10 15:35:58','200.00','1',0),(21,13,13,16,21,67,'2018-03-14 18:07:54','100.00','1',0),(22,14,1,17,21,66,'2018-03-09 17:15:44','100.00','1',1),(23,3,3,18,21,66,'2018-03-14 13:18:26','100.00','1',0),(25,13,4,19,21,66,'2018-03-14 13:18:25','100.00','1',0),(26,27,5,20,21,67,'2018-03-14 16:43:47','100.00','1',0),(27,19,1,34,21,66,'2018-03-11 00:00:00','200.00','2',1),(28,17,3,2,22,67,'2018-03-14 16:46:49','200.00','2',0),(29,22,9,22,21,67,'2018-03-14 18:08:56','200.00','2',0),(30,25,16,6,21,67,'2018-03-14 18:11:37','200.00','2',0);
...
CREATE TABLE `room` (
  ...
  `roomAmount` varchar(50) DEFAULT NULL COMMENT '床位数',
  `standardPriceDay` decimal(8,2) DEFAULT NULL COMMENT '标准房价/天',
  `standardPrice` decimal(8,2) DEFAULT NULL COMMENT '标准房价/小时',
  `maxDuration` varchar(50) DEFAULT NULL COMMENT '时长限制（小时）',
  `firstDuration` varchar(50) DEFAULT NULL COMMENT '首段时长（小时）',
...
insert  into `room`(`roomId`,`guestRoomLevelID`,`roomStateID`,`roomNumber`,`roomAmount`,`standardPriceDay`,`standardPrice`,`maxDuration`,`firstDuration`,`firstPrice`) values (3,8,65,'101','1','100.00','20.00','5','3','50.00'),(4,14,2,'501','3','10000.00','1800.00','5','3','5000.00'),(5,8,3,'404','1','1.00','1.00','1','1','1.00'),(9,8,4,'102','1','100.00','20.00','5','3','50.00'),(10,8,5,'103','1','100.00','20.00','5','3','50.00'),(11,8,6,'104','1','100.00','20.00','5','3','50.00'),(12,9,7,'105','1','150.00','30.00','5','3','80.00'),(13,8,65,'106','1','150.00','30.00','5','3','80.00'),(14,10,4,'107','2','200.00','40.00','5','3','100.00'),(16,10,65,'201','2','180.00','35.00','5','3','100.00'),(17,10,65,'202','2','180.00','35.00','5','3','100.00'),(18,11,1,'203','2','300.00','50.00','5','3','130.00'),(19,11,4,'204','3','300.00','50.00','5','3','130.00'),(20,13,4,'301','1','800.00','200.00','4','3','500.00'),(21,8,65,'3','23','2.00','2.00','2','2','2.00'),(22,13,65,'302','1','1200.00','99.00','5','3','500.00'),(23,12,1,'401','2','1000.00','88.00','5','3','700.00'),(24,14,1,'502','2','8000.00','1500.00','5','3','5000.00'),(25,8,1,'808','2','800000.00','80000.00','5','3','50000.00'),(26,8,65,'9999','99','999.00','999.00','9','5','99.00'),(27,10,65,'108','2','200.00','35.00','5','3','100.00'),(28,8,1,'109','2','200.00','35.00','5','3','100.00'),(29,11,1,'205','2','500.00','100.00','5','3','300.00'),(30,11,1,'206','2','600.00','99.00','5','3','300.00'),(31,11,1,'207','2','800.00','99.00','5','3','500.00'),(32,8,1,'208','2','800.00','100.00','5','3','500.00'),(34,11,1,'307','2','2000.00','2.00','05','03','888.80'),(36,13,1,'666','4','500.00','80.00','5','3','100.00');
...
CREATE TABLE `stayregister` (
  ...
  `stayNumber` varchar(50) DEFAULT NULL COMMENT '住店天数/小时',
  `sumConst` decimal(8,2) DEFAULT NULL COMMENT '总费用',
  `ChangingRoomNumber` varchar(50) DEFAULT NULL COMMENT '换房次数',

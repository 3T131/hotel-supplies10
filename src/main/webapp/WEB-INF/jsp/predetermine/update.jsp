...
<script type="text/javascript">
    ...
    function confirmfunction(){
        ...
        $('input[name="idTwo"]:checked').each(function(){             // 遍历获取input被checked的
            ...
            roomAmount.push(table.rows[selectedIndex-1].cells[3].innerHTML);
            roomPrice.push(table.rows[selectedIndex-1].cells[4].innerHTML);
            roomStant.push(table.rows[selectedIndex-1].cells[5].innerHTML);

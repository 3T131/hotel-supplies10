		...
		<div class="navbar">
			<div class="navbar-inner">
				<div class="container-fluid">
					...
					<a href="#"  class="brand">
						<small>
							${userSession.principal}--<c:if test="${userSession.targetTypeID==55}">经理</c:if><c:if test="${userSession.targetTypeID==56}">职员</c:if>
						</small>
					</a><!--/.brand-->
				</div><!--/.container-fluid-->
			</div><!--/.navbar-inner-->
...
<c:if test="${userSession.targetTypeID==55}">
					<li>
						<a id="ReceiveTargetId" onclick="ReceiveTargetId()" class="dropdown-toggle">
							<i class="icon-user"></i>
							<span class="menu-text">职员管理 </span>
						...
						<ul class="submenu">
							...
							<li>
								<a id="receiveTargetxxId" onclick="receiveTarget()" href="#">
									<i class="icon-double-angle-right"></i>
									<span>职员信息</span>
								</a>
							</li>
							<li>
								<a id="receiveTargetAddId" onclick="receiveTargetAdd()" href="#">
									<i class="icon-double-angle-right"></i>
									<span>新增职员</span>
								</a>
							</li>
...
//
			...
			function dataView(){
                document.getElementById("bigGuide").innerHTML='数据显示';
                document.getElementById("smallGuide").innerHTML="酒店房态";
                document.getElementById('Mainid').src='${ctx}/Main/todata';
			}
			...
			function receiveTarget(){
			     var a=document.getElementById("ReceiveTargetId").getElementsByTagName('span')[0].innerHTML;
			     document.getElementById("bigGuide").innerHTML=a+"";
			     var s=document.getElementById("receiveTargetxxId").getElementsByTagName('span')[0].innerHTML;
			     document.getElementById("smallGuide").innerHTML=s+"";
			     document.getElementById('Mainid').src='${ctx}/ReceiveTarget/tolist.do';
			}
            function receiveTargetAdd(){
                var a=document.getElementById("ReceiveTargetId").getElementsByTagName('span')[0].innerHTML;
                document.getElementById("bigGuide").innerHTML=a+"";
                var s=document.getElementById("receiveTargetAddId").getElementsByTagName('span')[0].innerHTML;
                document.getElementById("smallGuide").innerHTML=s+"";
                document.getElementById('Mainid').src='${ctx}/ReceiveTarget/toadd.do';
            }
